...
if isempty(NIST_data)
    ...
    % save('N2O_Properties_cgi.mat', 'data');
    data = load('N2O_Properties_cgi.mat');
    NIST_data.T = data.data.Temperature_0x28K0x29;
    NIST_data.h_liq = data.data.Enthalpy_0x28l0x2C_kJ0x2Fkg0x29;
    NIST_data.h_gas = data.data.Enthalpy_0x28v0x2C_kJ0x2Fkg0x29;
    NIST_data.e_liq = data.data.Internal_Energy_0x28l0x2C_kJ0x2Fkg0x29;
    NIST_data.e_gas = data.data.Internal_Energy_0x28v0x2C_kJ0x2Fkg0x29;
    NIST_data.cv_l = data.data.Cv_0x28l0x2C_J0x2Fg0x2AK0x29; % Cv for liquid
    NIST_data.cv_g = data.data.Cv_0x28v0x2C_J0x2Fg0x2AK0x29; % Cv for gas
    NIST_data.cp_l = data.data.Cp_0x28l0x2C_J0x2Fg0x2AK0x29; % Cp for liquid
    NIST_data.cp_g = data.data.Cp_0x28v0x2C_J0x2Fg0x2AK0x29; % Cp for gas
    NIST_data.s_l = data.data.Entropy_0x28l0x2C_J0x2Fg0x2AK0x29;
    NIST_data.s_g = data.data.Entropy_0x28v0x2C_J0x2Fg0x2AK0x29;
end
